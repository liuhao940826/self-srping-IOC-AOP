 ...
 * filterType 有五种点进去看
 */
@Import(value = {MyImportSelecter.class})
@Configuration
public class ApplicationImPortSelectorConfig {


        public static void main(String[] args) {

            //构造函数的参数千万不能忘记
            AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(ApplicationImPortSelectorConfig.class);
